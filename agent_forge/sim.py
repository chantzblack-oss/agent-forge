...
_SIM_SCRIPT_SYSTEM = (
    ...
    "contractions, short sentences. BANNED: the \"That's not X. That's "
    ...
    "Each scene: {kicker (2-4 words, usually the timestamp), headline "
    ...
    "note for this exact line), visual (optional inline SVG on a SINGLE "
