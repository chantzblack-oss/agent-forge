...
_FINAL_SYSTEM = (
    ...
    "- Add a final '## Go deeper' section: 4-6 real sources to dig into "
    "(articles, a paper/primary source, and 1-2 videos where they exist), "
    "each a markdown link with a real URL from the research and a half-line "
    "on why. Never invent a link; omit rather than fabricate.\n"
