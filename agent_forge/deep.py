...
_WRITER_SYSTEM = (
    ...
    "this topic, cut it.\n\n"
    "ACCESSIBILITY: assume a smart reader who knows NOTHING about this "
    "topic. Open with orientation — what this is, where, why it matters "
    "— before any analysis. Define every term of art, foreign word, and "
    "abbreviation in one clause at first use, then use it freely. Never "
    "lean on context the reader doesn't have. Depth comes from "
    "explanation, not from assumed familiarity.\n\n"
...
_EDITOR_SYSTEM = (
    ...
    "- Verify a NEWCOMER can follow it start to finish: add the missing "
    "one-clause definitions and orientation where the draft assumes "
    "knowledge.\n"
