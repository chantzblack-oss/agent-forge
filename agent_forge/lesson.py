...
_LESSON_VIDEO_SYSTEM = (
    ...
    "would work as a paragraph of the doc, cut it. Return 7-14 scenes — "
    ...
    "narration (1-3 spoken sentences in the video's chosen voice, no "
    "markdown — written like a person actually talks: contractions, short "
